...
- **Device**: Android phone (real device) with the Aroha APK installed and pre-loaded
...
### 0:15 — Meet Aroha + Memory (20 sec)

**Visual**:
- Quick onboarding montage: Welcome → Name → Conditions → Routine (fast, ~4s).
- Cut to chat: Aroha greets Geeta by name and references a condition — proving it *remembers*.
- **Calendar B-roll flash (~2s):** a quick swipe across the day/schedule view — register "it has a plan," don't stop on it.
- Tap to complete "BP Tablet" → count updates → Aroha: "Great start! 4 more today."
...
### 0:35 — WOW Moment #1 (HERO): Camera → Medication (30 sec)

**Visual**:
- Tap camera icon in chat input.
- Camera opens → take photo of printed pill strip.
- Loading spinner → editable card: "I read this as Metformin 500mg, twice daily after meals." (fields editable)
- Tap "Confirm & add to schedule."
- Calendar updates with new entry.
- Local notification preview: "Take Metformin — 12:00 PM"

**Audio**: > "New prescription? Just take a photo. Aroha reads it with Gemini Vision — name, dosage, frequency, instructions. Geeta confirms with one tap, and it's on the calendar with a reminder. This is the moment that makes Aroha different from any health app."
...
- One tap → Aroha generates a summary: recent symptoms, adherence this week, and 3 suggested questions to ask.

**Audio**: > "Everything Aroha captured now pays off. Before an appointment, one tap — and Aroha prepares a summary: how well Geeta stuck to her meds, and the questions worth asking her doctor. Aroha never overrides the doctor. It prepares Geeta so the doctor can do their job better."
...
- One line: "Advocates for you. Never overrides your doctor."
- Fade to Aroha AI logo + tagline.

**Audio**: > "Today Aroha remembers and reminds. The vision: a health advocate that reviews a prescription and hands you the right questions, reads a symptom photo and tells you when to see a doctor — always preparing you, never replacing your doctor. 153 million Indian seniors — doubling by 2050 — deserve that."
